...
function writeHikes() {
    ...
    hikesRef.add({
                      code:"BBY01",
        name: "Tien Cave Trail",    //replace with your own city?
        city: "Phong Nha",
        province: "Quang Binh",
        level: "medium",
        length: "10",
        details: "Quan goes here regularly",
        last_updated: firebase.firestore.FieldValue.serverTimestamp()  
    });
    hikesRef.add({
                      code:"AM01",
        name: "En Cave Trail",    //replace with your own city?
        city: "Phong Nha",
        province: "Quang Binh",
        level: "moderate",
        length: "10.5",
   ...
   hikesRef.add({
                      code:"NV01",
        name: "Son Doong cave",    //replace with your own city?
        city: "Phong Nha",
        province: "Quang Binh",
        level: "very hard",
        length: "8.2",
        details: "Quan goes here rarely",
